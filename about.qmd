...
2.  The models must be credible and ideally described openly so that you can see how they work.
...
5.  Stress from activities over time should be aggregated in a way that must be credible and not opaque.
